        ...
        <Col sm='12'>
          <div className='ecommerce-header-items'>
            <div className='result-toggler'>
              ...
              <span className='col-lg-3 col-md-3 col-sm-3 col-xs-12'>Produse pentru {store.params.category}</span>
              <span className='search-results col'>{productsPageTotal} produse ce corespund tuturor criteriilor selectate</span>
            </div>
            <div className='view-options d-flex'>
              <UncontrolledButtonDropdown className='dropdown-sort'>
                <DropdownToggle className='text-capitalize sm-1' color='primary' outline caret>
